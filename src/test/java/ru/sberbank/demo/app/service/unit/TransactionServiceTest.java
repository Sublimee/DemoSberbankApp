...
//
//    @Test
//    void withdrawTest() throws ResourceNotFoundException, WithdrawTransactionException {
//        Account account = new Account();
//        account.setBalance(POSITIVE_AMOUNT);
//        when(accountRepository.findById(anyLong())).thenReturn(Optional.of(account));
...
//
//    @Test
//    void transferTest() throws ResourceNotFoundException {
//        Account withdrawAccount = new Account();
//        withdrawAccount.setBalance(POSITIVE_AMOUNT);
//        withdrawAccount.setId(UUID.randomUUID());
...
//                .thenReturn(Optional.of(withdrawAccount))
//                .thenReturn(Optional.of(depositAccount));
//        assertThrows(TransferTransactionException.class, () -> transactionsService.transfer(UUID.randomUUID(), UUID.randomUUID(), 2 * POSITIVE_AMOUNT));
//    }
//
//}